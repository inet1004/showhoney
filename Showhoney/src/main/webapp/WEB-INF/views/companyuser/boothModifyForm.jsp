...
<body>
<div class="container">
    <form id="frm" name="frm" action="boothSelect.do" method="post" enctype="multipart/form-data">
    <div class="container-fluid video-player">
        <div class="container">
              <div style="margin-top:5%">
                 <label for="video"> 홍보영상 주소를 입력해 주세요 </label>
                   <input class="w3-input w3-border w3-animate-input" type="text" id="video_path" name="video_path" value="${list[0].video_path }">
               </div>
            <hr>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-6 light-bg pr-0 pd-md">
                            <label for="company_logo">Logo사진 첨부</label>
                             <input class="w3-input w3-border w3-round-large" id="booth_profile" name="booth_uploadfile" type="file" value="${list[0].booth_profile }">
                        </div>
