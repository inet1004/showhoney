	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center mb-5 pb-5">
				<c:choose>
					<c:when test="${companyAuth.company_user_auth == 'y' }">
					...
					<c:otherwise>
						<div>
							<h2>
								<strong>관리자 승인 후 부스생성이 가능합니다 :)</strong>
							</h2>
							<br />
							<br />
						</div>
					...
					<div class="col-md-4 ftco-animate">
						<div class="blog-entry">
							...
							<div class="text p-4 d-block">
								<div class="meta mb-3">
									<div>
										<a href="boothSelect.do?booth_no=${booth.booth_no }">${booth.company_name }</a>
									</div>
									&nbsp;
									<div>
								...
								<h3 class="heading">
									<a href="boothSelect.do?booth_no=${booth.booth_no }">${booth.booth_introduction }</a>
								</h3>
							</div>
						</div>
					</div>
